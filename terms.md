...
a) Realizar ingeniería inversa, descompilar, desensamblar o intentar derivar el código fuente.
b) Copiar, modificar, distribuir, vender, alquilar, sublicenciar o crear obras derivadas de la App.
...
Las métricas biomecánicas, fases deportivas, retroalimentación generada por IA, calificaciones, logros y cualquier otra información que la App muestre son **estimaciones algorítmicas** basadas en el video y los datos de seguimiento corporal disponibles en tu dispositivo, con limitaciones inherentes a la tecnología, la calidad del video, la iluminación, el ángulo de cámara y otros factores.

**Antes de iniciar, modificar o intensificar cualquier programa de entrenamiento o actividad física, consulta a un profesional de la salud calificado.**

## 6. Asunción de riesgos y responsabilidad del usuario

Al utilizar la App reconoces y aceptas que:

a) La actividad física conlleva **riesgo inherente** de lesión.
b) Eres **única y exclusivamente responsable** de tu condición física, de las actividades que realices, de tu seguridad y la de las personas que entrenes o evalúes.
c) Eres responsable del cumplimiento de las leyes aplicables al **grabar a personas**, incluidos menores de edad, así como del consentimiento informado correspondiente.
d) Eres responsable de la veracidad y legitimidad de los datos que ingresas en la App (nombres, fotos, deportes, etc.).

## 7. EXCLUSIÓN DE GARANTÍAS

LA APP SE PROPORCIONA **"TAL CUAL" Y "SEGÚN DISPONIBILIDAD"**, SIN GARANTÍAS DE NINGÚN TIPO, EXPRESAS O IMPLÍCITAS, INCLUYENDO, SIN LIMITACIÓN, GARANTÍAS DE COMERCIABILIDAD, IDONEIDAD PARA UN PROPÓSITO PARTICULAR, NO INFRACCIÓN O CONTINUIDAD DEL SERVICIO.

NO GARANTIZAMOS QUE LA APP:

- Funcione **libre de errores** o interrupciones.
- Sea **compatible** con todos los dispositivos, versiones de iOS o accesorios.
- Detecte o calcule métricas con **precisión absoluta**.
- Esté disponible de forma continuada, sin defectos o vulnerabilidades.
- Cumpla con tus **expectativas o necesidades específicas**.

La App se encuentra en **mejora continua**, lo que implica que funciones existentes pueden cambiar, ser refinadas o reemplazadas, y pueden surgir errores en versiones nuevas. Trabajamos para corregirlos con la mayor diligencia razonable.

## 8. LIMITACIÓN DE RESPONSABILIDAD

EN LA MÁXIMA MEDIDA PERMITIDA POR LA LEY APLICABLE, EL DESARROLLADOR NO SERÁ RESPONSABLE POR:

a) Daños indirectos, incidentales, especiales, consecuentes, ejemplares o punitivos.
b) Pérdida de ganancias, ingresos, oportunidad, datos, contratos, reputación o fondo de comercio.
c) Lesiones físicas, psicológicas o de cualquier otra naturaleza derivadas del uso de la App o de actividades físicas inspiradas en ella.
d) Interrupciones, fallos, pérdida de datos locales, incompatibilidades con futuras versiones de iOS, eliminación de la App de la App Store, o cualquier otra contingencia técnica.

LA RESPONSABILIDAD TOTAL ACUMULADA DEL DESARROLLADOR FRENTE AL USUARIO, POR CUALQUIER RECLAMACIÓN RELATIVA A LA APP, SE LIMITA AL **MONTO TOTAL QUE EL USUARIO HAYA PAGADO POR SUSCRIPCIONES DE LA APP DURANTE LOS TRES (3) MESES INMEDIATAMENTE ANTERIORES** AL HECHO QUE ORIGINE LA RECLAMACIÓN.

Algunas jurisdicciones no permiten la exclusión o limitación de ciertos daños; en ellas, esta limitación se aplicará en la mayor medida permitida por la ley.

## 9. Propiedad intelectual

La App, su código, diseño, gráficos, textos, logotipos y nombre comercial son propiedad del Desarrollador y están protegidos por las leyes de propiedad intelectual aplicables. Estos Términos no te transfieren ningún derecho de propiedad sobre la App.

El **contenido que generes** dentro de la App (videos, anotaciones, atletas, sesiones, notas, etc.) **te pertenece a ti**. Se almacena localmente en tu dispositivo.

## 10. Apple como tercero beneficiario

Reconoces que estos Términos son entre tú y el Desarrollador, **no con Apple Inc.** Apple no es responsable de la App ni de su contenido. No obstante, Apple y sus subsidiarias son **terceros beneficiarios** de estos Términos y podrán exigir su cumplimiento en lo que les concierna. Aplican adicionalmente los términos de Apple para el usuario final que pueden consultarse en https://www.apple.com/legal/internet-services/itunes/

## 11. Privacidad

El tratamiento de información personal se rige por nuestra **Política de Privacidad**, que forma parte integral de estos Términos. Léela aquí: [Política de Privacidad](./privacy.md).

## 12. Cambios a los Términos

Podemos modificar estos Términos en cualquier momento. Los cambios se publicarán en esta URL con la fecha actualizada. El uso continuado de la App tras la publicación implica tu aceptación de los Términos revisados. Si no estás de acuerdo, deja de usar la App y cancela tu suscripción.

## 13. Terminación

Podemos suspender o terminar tu acceso a la App, sin aviso previo, si incumples estos Términos. Tras la terminación, las cláusulas que por su naturaleza deban sobrevivir (propiedad intelectual, exclusión de garantías, limitación de responsabilidad, ley aplicable) permanecerán vigentes.

Tú puedes terminar tu uso de la App desinstalándola en cualquier momento y cancelando tu suscripción.

## 14. Ley aplicable y jurisdicción

Estos Términos se rigen por las leyes de los **Estados Unidos Mexicanos**, sin atender a sus principios de conflicto de leyes. Para cualquier controversia, las partes se someten a la **jurisdicción exclusiva de los tribunales competentes de la Ciudad de México**, renunciando a cualquier otro fuero que pudiera corresponderles.

## 15. Disposiciones generales

15.1 **Acuerdo íntegro:** estos Términos, junto con la Política de Privacidad, constituyen el acuerdo completo entre tú y el Desarrollador respecto al uso de la App.
15.2 **Divisibilidad:** si una cláusula resulta inválida, el resto continuará en pleno vigor.
15.3 **No renuncia:** el no ejercicio de un derecho no constituye renuncia al mismo.
15.4 **Cesión:** no puedes ceder tus derechos bajo estos Términos sin nuestro consentimiento; nosotros sí podemos cederlos a una afiliada o sucesor.
